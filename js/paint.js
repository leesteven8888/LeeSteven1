class PaintManager {
  ...
  initPaintTools() {
    document.getElementById('brush-mode').addEventListener('click', () => {
      if (this.currentTool === 'brush') {
        ...
        this.setActiveTool('brush', 'Chế độ bút vẽ');
    ...
    document.getElementById('text-mode').addEventListener('click', () => {
      if (this.currentTool === 'text') {
        ...
        this.setActiveTool('text', 'Chèn văn bản');
        this.brushColor = document.getElementById('brush-color').value;
      }
    });
  ...
  startTextPlacement() {
    ...
    // Add visual feedback
    setCanvasTitle('Nhấp vào canvas để đặt văn bản');
  ...
  placeText(e) {
    ...
    this.isTextPlacementMode = false;
    this.canvas.classList.remove('text-placement-mode');
    setCanvasTitle('Kéo văn bản mới thêm để chỉnh vị trí');
  }
